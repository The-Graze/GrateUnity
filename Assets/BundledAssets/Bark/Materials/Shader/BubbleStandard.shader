Shader "Tazo/BubbleStandard"
{
	Properties
	{
		...
		_AlphaMode("Alpha", Range(-1,1)) = 0.00
...
//shell
		Pass
		{
			...
			float4 frag(v2f i) : SV_Target
			{
				...
				cc.rgb = lerp(p1,p2, i.cap.z)* _MColor + _RimColor.rgb*_RimColor.a* i.color.r + mtp;
				cc.a =  lerp(cc.r, 1, _AlphaMode)* mc.r*i.cap.w + _RimColor.r * _RimColor.a * i.color.r + mtp;
				return cc;
			}
			ENDCG
		}
